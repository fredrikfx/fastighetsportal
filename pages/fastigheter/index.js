              ...
              >
                <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 transform group-hover:scale-[1.02] group-hover:shadow-lg h-full flex flex-col">
                  ...
                  <div className="relative h-64 bg-gray-200 overflow-hidden">
                    <img 
                      src={index === 0 ? '/images/casa-muheve-1.JPG' : 
                           index === 1 ? '/images/villa-solsken-1.JPG' : 
                           '/images/apartment-marina-1.JPG'} 
                      alt={fastighet.namn || 'Fastighet'} 
                      className="w-full h-full object-cover transition-all duration-300 group-hover:scale-105"
                    />
                    
                    {/* Debug-info */}
                    <div className="absolute top-0 left-0 bg-black bg-opacity-70 text-white p-1 text-xs">
                      ID: {fastighet.id} | Index: {index}
                    </div>
